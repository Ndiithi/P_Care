...
import { getPurchases } from '../../utils/Helpers';

class PurchasesReport extends React.Component {
        ...
        return (
            <React.Fragment>
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h4 mb-0 text-gray-500">Purchases Report</h1>
                </div>
                {pageContent}
...
if (document.getElementById('purchases')) {
    ReactDOM.render(<PurchasesReport />, document.getElementById('purchases'));
}
